...
<section class="edit-comment">
   ...
   <form action="" method="post">
      ...
      <div class="flex">
         <a href="comments.php" class="inline-option-btn">الغاء تعديل</a>
   ...
   <div class="show-comments">
      ...
      <div class="box" style="<?php if($fetch_comment['user_id'] == $user_id){echo 'order:-1;';} ?>">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="edit_comment" class="inline-option-btn">إضافة تعليق</button>
      ...
      <?php
         ...
         echo '<p class="empty">لايوجد تعليق بعد!</p>';
      }
      ?>
      </div>
