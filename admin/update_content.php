...
<section class="video-form">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <select name="playlist" class="box">
         <option value="<?= $fecth_videos['playlist_id']; ?>" selected>--اختيار قائمة</option>
         <?php
         ...
         <?php
            ...
            echo '<option value="" disabled>لم يتم إضافة محتوى بعد!</option>';
         }
         ?>
      </select>
      <img src="../uploaded_files/<?= $fecth_videos['thumb']; ?>" alt="">
      <p>تحميل صورة الفيديو</p>
      ...
      <div class="flex-btn">
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="option-btn">مشاهدة المحتوى</a>
   ...
   <?php
         ...
         echo '<p class="empty">لايوجد فيديو! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">إضافة فيديو</a></p>';
      }
   ?>
