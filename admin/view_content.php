   ...
   <div class="container">
      ...
      <form action="" method="post">
         <div class="flex-btn">
            ...
            <input type="submit" value="حذف" class="delete-btn" onclick="return confirm('هل تريد حذف الفيديو?');" name="delete_video">
         </div>
      </form>
   </div>
   <?php
      ...
      echo '<p class="empty">لم يتم إضافة محتوى بعد! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">إضافة فيديو</a></p>';
   }
...
<section class="comments">
   ...
   <h1 class="heading">تعليق المستخدمين</h1>
   ...
   <div class="show-comments">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <button type="submit" name="delete_comment" class="inline-delete-btn" onclick="return confirm('هل تريد حذ تعليق?');">حذف التعليق</button>
         </form>
      </div>
      <?php
       }
      }else{
         echo '<p class="empty">لايوجد تعليقات بعد!</p>';
      }
      ?>
      </div>
