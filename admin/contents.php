   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="حذف" class="delete-btn" onclick="return confirm('delete this video?');" name="delete_video">
         </form>
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn"> مشاهدة محتوى</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">لم يتم إضافه محتوى بعد!</p>';
      }
   ?>
