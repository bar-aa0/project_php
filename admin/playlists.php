...
if(isset($_POST['delete'])){
   ...
   $message[] = 'القائمة محذوفه!';
   }else{
      $message[] = ".القائمة محذوفة بالفعل!";
   }
}
...
<section class="playlists">
   ...
   <h1 class="heading">القوائم المضافة</h1>

   <div class="box-container">
   
      <div class="box" style="text-align: center;">
         <h3 class="title" style="margin-bottom: .5rem;">إنشاء قائمة جديدة</h3>
         <a href="add_playlist.php" class="btn">إضافه قائمة</a>
      </div>
      ...
      <div class="box">
         ...
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">مشاهدة القائمة</a>
      </div>
      <?php
         } 
      }else{
