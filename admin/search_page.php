   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="delete" class="delete-btn" onclick="return confirm('هل تريد حذف الفيديو?');" name="delete_video">
         </form>
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">مشاهدة المحتويات</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">لم نجد محتوى البحث!</p>';
      }
   }else{
      echo '<p class="empty">رجاء اخل هنا للبحث!</p>';
   }
   ?>
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">تحميل</a>
            <input type="submit" value="delete_playlist" class="delete-btn" onclick="return confirm('delete this playlist?');" name="delete">
         </form>
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">مشاهدة القوائم</a>
      </div>
      <?php
         } 
      }else{
         echo '<p class="empty">لم يتم إضافة قائمة!</p>';
      }}else{
         echo '<p class="empty">البحث عن اي شيء تريد!</p>';
      }
      ?>
