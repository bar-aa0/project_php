...
<section class="playlist-form">
   ...
   <h1 class="heading">تحميل قائمة</h1>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex-btn">
         ...
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">مشاهدة القائمة</a>
      </div>
   </form>
   <?php
      } 
   }else{
      echo '<p class="empty">لم يتم إضافة قائمة بعد!</p>';
   }
   ?>
