...
<section class="playlist-details">
   ...
   <h1 class="heading">مشاهدة القوائم</h1>
   ...
   <div class="row">
      ...
      <div class="details">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_playlist.php?get_id=<?= $playlist_id; ?>" class="option-btn">تحديث القائمة</a>
            <input type="submit" value="delete playlist" class="delete-btn" onclick="return confirm('هل تريد حذف القائمة?');" name="delete">
         </form>
      </div>
   </div>
   <?php
         ...
         echo '<p class="empty">لم يتم تحيل قائمة بعد!</p>';
      }
   ?>
...
<section class="contents">
   ...
   <h1 class="heading">فيديو القائمة</h1>
   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <a href="update_content.php?get_id=<?= $video_id; ?>" class="option-btn">تحميل</a>
            <input type="submit" value="delete" class="delete-btn" onclick="return confirm('delete this video?');" name="delete_video">
         </form>
         <a href="view_content.php?get_id=<?= $video_id; ?>" class="btn">مشاهدة الفيديو</a>
      </div>
   <?php
         }
      }else{
         echo '<p class="empty">لم يتم إضافة فيديو بعد! <a href="add_content.php" class="btn" style="margin-top: 1.5rem;">إضافة فيديو</a></p>';
      }
   ?>
