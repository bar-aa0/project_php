...
<section class="liked-videos">
   ...
   <h1 class="heading">إعجابات الفيديوهات</h1>
   ...
   <div class="box">
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <a href="watch_video.php?get_id=<?= $fetch_contents['id']; ?>" class="inline-btn">مشاهدة الفيديو</a>
   ...
   <?php
            ...
            echo '<p class="emtpy">لايوجد محتوى!</p>';         
         }
      }
   }else{
      echo '<p class="empty">لم يتم إضافات إعجابات بعد!</p>';
   }
   ?>
